...
my_layer_pre = partial(tf.layers.dense, kernel_initializer=he_init, kernel_regularizer=tf.contrib.layers.l2_regularizer(scale))
...
with tf.name_scope("dnn1"):
    ...
    logits_pre = tf.layers.dense(hidden1_act, n_outputs, name="output")
